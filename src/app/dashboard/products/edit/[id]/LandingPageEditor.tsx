...
type ThemeKey = "classic" | "bold" | "trust" | "minimal" | "videoHero";

const THEMES: { value: ThemeKey; label: string; hint: string }[] = [
  { value: "classic", label: "Classic (ecorybd)", hint: "Sales-letter style — Pain → Benefits → HowTo → Checkout" },
  { value: "bold", label: "Bold", hint: "Punchy, fewer sections, amber CTA" },
  { value: "trust", label: "Trust", hint: "Heavy on badges/guarantee, green CTA" },
  { value: "minimal", label: "Minimal", hint: "Distraction-free single column" },
  { value: "videoHero", label: "Video Hero (VSL)", hint: "Hero replaced with a YouTube/Vimeo embed" },
];
